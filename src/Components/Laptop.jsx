                ...
                <form >
                    ...
                    >
                        ...
                        <div className="a-box-inner a-alert-container">
                            ...
                            >)
                            <div className="a-popover-preload" id="a-popover-alert-0-1">
                                <span
                                >Amazon takes your security seriously, and monitors activity on
                                your account to keep your account and payment methods safe.</span
                                >
                                <ul className="a-unordered-list a-vertical">
                                <li>
                                    <span className="a-list-item"
                                    >We noticed unusual payment activity on your account.</span
                                    >
                                </li>
                                <li>
                                    <span className="a-list-item"
                                    >We have temporarily placed your account on hold so we could
                                    review it with you.</span
                                    >
                                </li>
                                <li>
                                    <span className="a-list-item"
                                    >While your account is on hold, your pending orders are also
                                    on hold and may be cancelled.</span
                                    >
                                </li>
                                <li>
                                    <span className="a-list-item"
                    ...
                    <div className="a-section a-spacing-none">
                        <div className="a-section a-spacing-none">
                        <label className="a-form-label">Country/Region</label
                    ...
                    <div className="a-section a-spacing-none">
                        <div className="a-section a-spacing-none">
                        <label className="a-form-label"
                            ><i className="input-field-required"></i> State/Province/Region</label
                        ><input
                            type="text"
                            maxLength="100"
                            value={region}
                    ...
                    <div
                    className="custom-your-card abbott-view-component component-width-extra_large"
                    >
                    <div
                        id=""
                    ...
                    >
                        ...
                        >
                            ...
                            ><span className="a-label a-radio-label"
                                >Redacted billing statement (Credit / Debit card, Bank account)
                                <span
                                className="a-declarative"
                                ...
                                >
                                <span
                                    >The following information must be clearly displayed on the
                                    statement:</span
                                >
                                <ol className="a-ordered-list a-vertical">
                                    ...
                                    <li>
                                    <span className="a-list-item"
                                        >Phone number (if included in your billing statement)</span
                                    >
                                    </li>
                                    <li>
                                    <span className="a-list-item"
                                        >Last 4 digits of the card or account number</span
                                    >
                                    </li>
                                </ol>
                                </div></span
                        ...
                        <div className="a-section a-spacing-none">
                            ...
                            <div className="a-box-inner a-alert-container">
                                ...
                                Please ensure ONLY the last four digits of the card are
                                visible.<br />For your security, do NOT include full card or
                                account numbers.
                                </div>
                            </div>
                            </div>
                    ...
                    <div data-name="document" className="a-section a-spacing-none file-upload">
                        ...
                        <div className="a-box-inner">
                            ...
                            <div className="placeholder">or drop file here</div>
                        </div>
                        </div>
                        <input
                        type="hidden"
                        ...
                        <div className="a-section a-spacing-none">
                            ...
                            <div
                            data-target-name="comments"
                            className="a-section a-spacing-none character-counter-text hidden"
                            >
                        ...
                        <span
                            ...
                            comments. Do not include personal information in these comments.</span
                        >
                        </div>
                    ...
                    <div className="a-section abbott-view-footer">
                        <div className="a-section a-spacing-none">
                            <div className="a-section abbott-view-component">
                                <div className="a-section a-spacing-extra-large a-spacing-top-extra-large"><div className="a-divider a-divider-section"><div className="a-divider-inner"></div></div><div className="a-section"><div className="a-section a-text-center a-spacing-small"><a className="a-size-mini a-link-normal a-padding-mini" target="_blank" href="https://www.amazon.com/gp/help/customer/display.html/?ie=UTF8&nodeId=508088">Conditions of Use</a><a className="a-size-mini a-link-normal a-padding-mini" target="_blank" href="https://www.amazon.com/gp/help/customer/display.html/?ie=UTF8&nodeId=468496">Privacy Notice</a><a className="a-size-mini a-link-normal a-padding-mini" target="_blank" href="https://www.amazon.com/gp/help/customer/display.html">Help</a></div><div className="a-section a-text-center a-size-mini a-color-secondary">© 1996-2024, Amazon.com, Inc. or its affiliates.</div></div></div>
                            </div>
                        </div>
                    </div>
