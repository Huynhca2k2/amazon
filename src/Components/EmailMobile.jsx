                ...
                <div className="a-box-inner a-alert-container">
                    ...
                    <ul className="a-unordered-list a-nostyle a-vertical" role="alert">
                        ...
                        <span className="a-list-item">
                            Please check your email address or click Create Account if
                            you are new to Amazon.
                        </span>
                        </li>
                    </ul>
                    </div>
        ...
        <div className="a-section auth-pagelet-mobile-container">
            ...
            <div className="a-box-inner a-alert-container">
                ...
                >
                    ...
                    <span className="a-list-item"> Enter your name </span>
                    </li>
                    ...
                    <span className="a-list-item"> Enter your mobile number </span>
                    </li>
                    ...
                    <span className="a-list-item">
                        Please read and agree to Amazon's Conditions of Use and
                        Privacy Policy
                    </span>
                    </li>
                    <li id="auth-cbdtAgreementCheckBox-unchecked-alert">
                    <span className="a-list-item">
                        To create an account with Amazon, please agree to our
            ...
            <div id="outer-accordion-signin-signup-page" className="a-section">
            <h2>Welcome</h2>
            ...
            >
                ...
                <div className="a-box-inner a-accordion-row-container">
                    ...
                    <a
                        ...
                        ><i
                        className="a-icon a-accordion-radio a-icon-radio-inactive"
                        ></i>
                        <h5>
                        <div className="a-row">
                    ...
                    <div className="a-section a-spacing-large mp_reg_fix">
                        ...
                        <div className="a-row a-spacing-base">
                            ...
                            <div
                            className="a-input-text-wrapper auth-required-field accordionFontFamily"
                            >
                            <input
                                type="text"
                                maxLength="50"
                            ...
                            <div className="a-box-inner a-alert-container">
                                ...
                                <div className="a-alert-content">Enter your name</div>
                            </div>
                            </div>
                        </div>
                        ...
                        <div className="a-row a-spacing-base">
                            ...
                            >
                                ...
                                >
                                <span className="country-display-text">US +1</span>
                                </span>
                            </div>
                            <input
                                type="email"
                            ...
                            <div className="a-box-inner a-alert-container">
                                <i className="a-icon a-icon-alert"></i>
                                <div className="a-alert-content">
                                Wrong or Invalid email address or mobile phone
                                number. Please correct and try again.
                                </div>
                            </div>
                            </div>
                        ...
                        <div className="a-row">
                            ...
                            >
                                ...
                                ><span className="a-label a-checkbox-label">
                                    <span
                                    className="a-size-small auth-password-margin"
                                    >
                                    Show password
                                    </span>
                                </span></label
                        ...
                        <div className="a-section ap_mobile_number_fields">
                            ...
                            ><span className="a-button-inner"
                                ...
                                >
                                <span
                                    className="default-text aok-hidden display-none"
                                    >Continue</span
                                >
                                <span
                                    className="phone-text aok-hidden display-none"
                        ...
                        <div id="legal-section" className="a-section">
                            <div
                            id="legalTextRow"
                            ...
                            <a
                                href="/gp/aw/help/ref=ap_mobile_register_notification_condition_of_use?id=508088"
                                >Conditions of Use</a
                            >
                            and
                            <a
                                href="/gp/aw/help/ref=ap_mobile_register_notification_privacy_notice?id=468496"
                                >Privacy Notice</a
                            >.
                            </div>
                        </div>

                        <div id="ab-reg-link-section" className="a-section">
                ...
                <div className="a-box-inner a-accordion-row-container">
                    ...
                    <a
                        ...
                        ><i
                        className="a-icon a-accordion-radio a-icon-radio-active"
                        ></i>
                        <h5>
                        <div className="a-row">
                            <span className="a-size-base a-text-bold">Sign in</span>
                    ...
                    >
                        ...
                        <div className="a-box-inner a-alert-container">
                            ...
                            <p id="passkey-client-error-message">
                                Something went wrong, please sign-in another way
                                or follow any instructions provided by your
                                device.
                            </p>
                            <p
                                ...
                                className="aok-hidden"
                            >
                                Sorry, your passkey isn't working. There might be
                                a problem with the server. Sign in with your
                                password or try your passkey again later.
                            </p>
                            <p
                        ...
                        <div className="a-row a-spacing-base">
                            ...
                            >
                            <div
                                className="a-input-text-wrapper auth-required-field auth-fill-claim moa-single-claim-input-field-container"
                            >
                                <div
                                className="a-section country-picker aok-hidden display-none"
                                value="US"
                        ...
                        <div className="a-button-stack">
                            ...
                            >
                                ...
                                <a
                                href="/gp/aw/help/ref=ap_mobile_signin_notification_condition_of_use?id=508088"
                                > Conditions of Use </a
                                >
                                and
                                <a
                                href="/gp/aw/help/ref=ap_mobile_signin_notification_privacy_notice?id=468496"
                                > Privacy Notice</a
                                >.
                            </div>
                            </div>
                        ...
                        <div className="a-section">
                        <div
                            className="a-row a-expander-container a-expander-inline-container"
                        >
                            <a
                    ...
                    <div id="ab-signin-link-section" className="a-section">
                        <hr aria-hidden="true" className="a-divider-normal" />
                        <div className="a-section a-spacing-micro">
                        <span className="a-text-bold"> Buying for work? </span>
                        </div>
