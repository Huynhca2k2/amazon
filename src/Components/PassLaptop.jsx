    ...
    <div className="a-section a-padding-medium auth-workflow">
      <div className="a-section a-spacing-none auth-navbar">
        <div className="a-section a-spacing-medium a-text-center">
          <a className="a-link-nav-icon" tabIndex="-1" href="/ref=ap_frn_logo">
              ...
              >
                <div className="a-box-inner a-alert-container">
                  ...
                  <div className="a-alert-content">
                    <ul
                      className="a-unordered-list a-nostyle a-vertical a-spacing-none"
                    >
                      <li>
                ...
                <div className="a-box-inner a-alert-container">
                  ...
                  <div className="a-alert-content">
                    <p id="passkey-client-error-message">
                      Something went wrong, please sign-in another way or
                      follow any instructions provided by your device.
                    </p>
                    <p
                      id="passkey-generic-server-error-message"
                      className="aok-hidden"
                    >
                      Sorry, your passkey isn't working. There might be a
                      problem with the server. Sign in with your password or
                      try your passkey again later.
                    </p>
                    <p
                ...
                <div className="a-box-inner a-padding-extra-large">
                  ...
                  <div className="a-row a-spacing-base">
                    ...
                    <a
                      ...
                      tabIndex="5"
                      href="https://www.amazon.com/ap/signin?showRememberMe=true&amp;openid.pape.max_auth_age=0&amp;openid.identity=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&amp;signInRedirectToFPPThreshold=5&amp;pageId=usflex&amp;openid.return_to=https%3A%2F%2Fwww.amazon.com%2F%3Fref_%3Dnav_custrec_signin&amp;prevRID=7ENZ1K9K36J7FTRETKQ7&amp;openid.assoc_handle=usflex&amp;openid.mode=checkid_setup&amp;prepopulatedLoginId=eyJjaXBoZXIiOiJBKzQvZGt6M2F4UFlkOXNkeGhuV1ZBPT0iLCJJViI6IkZZRHo4VUdtdm5MRlhoaUFkTmlvY1E9PSIsInZlcnNpb24iOjF9&amp;failedSignInCount=1&amp;openid.claimed_id=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&amp;openid.ns=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0&amp;timestamp=1709583220000&amp;ref_=ap_pwd_change"
                    >
                      {' '}Change
                    </a>
                  </div>
                    ...
                    <div className="a-section">
                      ...
                      <div className="a-section a-spacing-large">
                        <div className="a-row">
                          ...
                          <div
                            className="a-column a-span7 a-text-right a-span-last"
                          >
                            <a
                              ...
                              >
                                <label
                                  ><input
                                    ...
                                    value="true"
                                    tabIndex="4" /><i
                                    className="a-icon a-icon-checkbox"
                                  ></i
